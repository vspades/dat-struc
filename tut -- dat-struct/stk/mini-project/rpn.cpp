...
int main() {
	...
	cout<<endl; 
	cout << "Input each entry literal by literal and press ENTER." << endl;
	cout << "You can also substitude <x> with any desired value." << endl;
	cout << "At the end input < = > symbol to see the result." << endl;
